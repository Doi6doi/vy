...
`$30`: the number 0  
`$7C`: the number 1  
`$31$`: integer storable in 8 bits (-128 .. 127)  
`$32${2}`: integer storable in 16 bits (-32768..32767)  
`..`  
`$38${8}`: integer storable in 64 bits
`$39(size:int)${size}`: integer stored in size bits
...
`$40(days:int)`: version value

 - days: number of days passed since 1970.01.01
